...
inline size_t dtype_alignment(DType dt) { return dtype_size(dt); }
...
template <typename T> struct DTypeOf {
  static constexpr DType value = DType::Void;
};
...
template <> struct DTypeOf<int32_t> {
